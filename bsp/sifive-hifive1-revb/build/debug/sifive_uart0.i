# 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_uart0.c"
...
# 5 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_uart0.c" 2
...
# 9 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_uart0.c" 2
# 1 "./metal/machine.h" 1
# 89 "./metal/machine.h"
...
# 10 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_uart0.c" 2
# 36 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_uart0.c"
struct metal_interrupt *
...
int __metal_driver_sifive_uart0_tx_interrupt_enable(struct metal_uart *uart) {
    ...
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 16UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 16UL))))) |= (1 << 0);
    return 0;
}
...
int __metal_driver_sifive_uart0_rx_interrupt_enable(struct metal_uart *uart) {
    ...
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 16UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 16UL))))) |= (1 << 1);
    return 0;
}
...
int __metal_driver_sifive_uart0_txready(struct metal_uart *uart) {
    ...
    return !!((((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 0UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 0UL))))) & (1 << 31)));
}
...
int __metal_driver_sifive_uart0_set_tx_watermark(struct metal_uart *uart,
    ...
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 8UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 8UL))))) |= ((0x7 & level) << 16);
    return 0;
}
...
size_t __metal_driver_sifive_uart0_get_tx_watermark(struct metal_uart *uart) {
    ...
    return ((((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 8UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 8UL))))) >> 16) & 0x7);
}
...
int __metal_driver_sifive_uart0_set_rx_watermark(struct metal_uart *uart,
    ...
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 12UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 12UL))))) |= ((0x7 & level) << 16);
    return 0;
}
...
size_t __metal_driver_sifive_uart0_get_rx_watermark(struct metal_uart *uart) {
    ...
    return ((((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 12UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 12UL))))) >> 16) & 0x7);
}
...
int __metal_driver_sifive_uart0_putc(struct metal_uart *uart, int c) {
    ...
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 0UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 0UL))))) = c;
    return 0;
}
...
int __metal_driver_sifive_uart0_getc(struct metal_uart *uart, int *c) {
    ...
    ch = ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 4UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 4UL)))));
    ;
    if (ch & (1 << 31)) {
        *c = -1;
    } else {
...
int __metal_driver_sifive_uart0_set_baud_rate(struct metal_uart *guart,
    ...
    if (clock != 
# 144 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_uart0.c" 3 4
                ((void *)0)
# 144 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_uart0.c"
                    ) {
        long clock_rate = clock->vtable->get_rate_hz(clock);
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 24UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 24UL))))) = clock_rate / baud_rate - 1;
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 8UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 8UL))))) |= (1 << 0);
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 12UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 12UL))))) |= (1 << 0);
    }
    return 0;
}
...
static void pre_rate_change_callback_func(void *priv) {
    ...
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 8UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 8UL))))) &= ~(((0x7 & 0x7) << 16));
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 8UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 8UL))))) |= ((0x7 & 1) << 16);

    while ((((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 20UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 20UL))))) & (1 << 0)) == 0)
        ;
    ...
    long bits_per_symbol =
        (((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 8UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 8UL))))) & (1 << 1)) ? 9 : 10;
...
void __metal_driver_sifive_uart0_init(struct metal_uart *guart, int baud_rate) {
    ...
    if (clock != 
# 193 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_uart0.c" 3 4
                ((void *)0)
# 193 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_uart0.c"
                    ) {
    ...
    if (pinmux != 
# 209 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_uart0.c" 3 4
                 ((void *)0)
# 209 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_uart0.c"
                     ) {
