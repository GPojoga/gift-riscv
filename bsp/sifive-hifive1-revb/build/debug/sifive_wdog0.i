# 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_wdog0.c"
...
# 5 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_wdog0.c" 2
...
# 8 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/sifive_uart0.h" 2
...
# 9 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/sifive_uart0.h" 2
...
# 9 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/riscv_plic0.h" 2
...
# 10 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/sifive_uart0.h" 2
...
# 11 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/sifive_uart0.h" 2
...
# 12 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/sifive_uart0.h" 2
...
# 9 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_wdog0.c" 2
# 1 "./metal/machine.h" 1
# 89 "./metal/machine.h"
...
# 10 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_wdog0.c" 2
...
# 12 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_wdog0.c" 2
# 40 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_wdog0.c"
int __metal_driver_sifive_wdog0_feed(const struct metal_watchdog *const wdog) {
    ...
    (((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 28UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 28UL))))) = 5370206UL); ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 24UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 24UL))))) =
        218755085UL;
...
__metal_driver_sifive_wdog0_get_rate(const struct metal_watchdog *const wdog) {
    ...
    const unsigned int scale = (((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 0UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 0UL))))) &
                                7);
...
__metal_driver_sifive_wdog0_set_rate(const struct metal_watchdog *const wdog,
    ...
    if (rate >= clock_rate) {
        ...
        (((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 28UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 28UL))))) = 5370206UL); ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 0UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 0UL))))) &=
            ~(7);
        return clock_rate;
    }


    long min_diff = 0x7fffffffL;
...
long int __metal_driver_sifive_wdog0_get_timeout(
    ...
    return (((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 32UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 32UL))))) & 0xFFFF);
}
...
__metal_driver_sifive_wdog0_set_timeout(const struct metal_watchdog *const wdog,
    ...
    const long int set_timeout =
        timeout > 0xFFFF ? 0xFFFF : timeout;





    uint32_t wdogcmp = ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 32UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 32UL)))));

    wdogcmp &= ~(0xFFFF);
    wdogcmp |= set_timeout;

    (((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 28UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 28UL))))) = 5370206UL); ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 32UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 32UL))))) = wdogcmp;
...
int __metal_driver_sifive_wdog0_clear_interrupt(
    ...
    (((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 28UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 28UL))))) = 5370206UL); ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 0UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 0UL))))) &= ~((1 << 28));

    return 0;
}

const struct __metal_driver_vtable_sifive_wdog0 __metal_driver_vtable_sifive_wdog0 = {
