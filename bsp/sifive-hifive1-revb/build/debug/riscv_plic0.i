# 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c"
...
# 5 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c" 2
...
# 8 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/riscv_plic0.h" 2
...
# 11 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c" 2
...
# 13 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c" 2
# 1 "./metal/machine.h" 1
# 89 "./metal/machine.h"
...
# 14 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c" 2
...
# 15 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c" 2
...
__metal_plic0_claim_interrupt(struct __metal_driver_riscv_plic0 *plic,
    ...
    return (*(__typeof__(*(__metal_io_u32 *)(control_base + 2097152UL + (context_id * 4096UL) + 4UL)) volatile *)((__metal_io_u32 *)(control_base + 2097152UL + (context_id * 4096UL) + 4UL)))
...
void __metal_plic0_complete_interrupt(struct __metal_driver_riscv_plic0 *plic,
    ...
    unsigned long control_base = __metal_driver_sifive_plic0_control_base(
        (struct metal_interrupt *)plic);
    (*(__typeof__(*(__metal_io_u32 *)(control_base + 2097152UL + (context_id * 4096UL) + 4UL)) volatile *)((__metal_io_u32 *)(control_base + 2097152UL + (context_id * 4096UL) + 4UL)))
...
int __metal_plic0_set_threshold(struct metal_interrupt *controller,
    ...
    (*(__typeof__(*(__metal_io_u32 *)(control_base + 2097152UL + (context_id * 4096UL) + 0UL)) volatile *)((__metal_io_u32 *)(control_base + 2097152UL + (context_id * 4096UL) + 0UL)))
...
unsigned int __metal_plic0_get_threshold(struct metal_interrupt *controller,
    ...
    unsigned long control_base =
        __metal_driver_sifive_plic0_control_base(controller);
    return (*(__typeof__(*(__metal_io_u32 *)(control_base + 2097152UL + (context_id * 4096UL) + 0UL)) volatile *)((__metal_io_u32 *)(control_base + 2097152UL + (context_id * 4096UL) + 0UL)))
...
int __metal_driver_riscv_plic0_set_priority(struct metal_interrupt *controller,
    ...
    if ((max_priority) && (priority < max_priority)) {
        (*(__typeof__(*(__metal_io_u32 *)(control_base + 0UL + (id << 2))) volatile *)((__metal_io_u32 *)(control_base + 0UL + (id << 2))))
...
__metal_driver_riscv_plic0_get_priority(struct metal_interrupt *controller,
    ...
    return (*(__typeof__(*(__metal_io_u32 *)(control_base + 0UL + (id << 2))) volatile *)((__metal_io_u32 *)(control_base + 0UL + (id << 2))))
...
int __metal_plic0_enable(struct __metal_driver_riscv_plic0 *plic,
    ...
    current = (*(__typeof__(*(__metal_io_u32 *)(control_base + 8192UL + (context_id * 128UL) + (id >> 5) * 4)) volatile *)((__metal_io_u32 *)(control_base + 8192UL + (context_id * 128UL) + (id >> 5) * 4)))


                                                                ;
    (*(__typeof__(*(__metal_io_u32 *)(control_base + 8192UL + (context_id * 128UL) + ((id >> 5) * 4))) volatile *)((__metal_io_u32 *)(control_base + 8192UL + (context_id * 128UL) + ((id >> 5) * 4))))


                                                                   =
        enable ? (current | (1 << (id & 0x1F)))
               : (current & ~(1 << (id & 0x1F)));
        ...
        for (int parent = 0; parent < 1; parent++) {
            ...
            for (int i = 0; i < 1024; i++) {
                ...
                if (i < num_interrupts) {
                    ...
                    plic->metal_exint_table[i] = 
# 145 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c" 3 4
                                                ((void *)0)
# 145 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c"
                                                    ;
                    plic->metal_exdata_table[i].sub_int = 
# 146 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c" 3 4
                                                         ((void *)0)
# 146 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c"
                                                             ;
                    plic->metal_exdata_table[i].exint_data = 
# 147 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c" 3 4
                                                            ((void *)0)
# 147 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c"
                                                                ;
                }
            }
            ...
            intc->vtable->interrupt_register(intc, line, 
# 154 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c" 3 4
                                                        ((void *)0)
# 154 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_plic0.c"
                                                            , plic);
...
int __metal_driver_riscv_plic0_enable(struct metal_interrupt *controller,
    ...
    __metal_plic0_enable(plic, __metal_myhart_id(), id, 1);
    return 0;
}
...
int __metal_driver_riscv_plic0_disable(struct metal_interrupt *controller,
    ...
    __metal_plic0_enable(plic, __metal_myhart_id(), id, 0);
    return 0;
}
...
__metal_driver_riscv_plic0_affinity_enable(struct metal_interrupt *controller,
    ...
    for (context = 0; bitmask.bitmask; context++, bitmask.bitmask >>= 1) {
        if (context != 0)
            ret.bitmask |= ((__metal_plic0_enable(plic, context, id, 1) & 0x1) << context);
...
__metal_driver_riscv_plic0_affinity_disable(struct metal_interrupt *controller,
    ...
    for (context = 0; bitmask.bitmask; context++, bitmask.bitmask >>= 1) {
        if (context != 0)
            ret.bitmask |= ((__metal_plic0_enable(plic, context, id, 0) & 0x1) << context);
...
metal_affinity __metal_driver_riscv_plic0_affinity_set_threshold(
    ...
    for (context = 0; bitmask.bitmask; context++, bitmask.bitmask >>= 1) {
        if (context != 0)
            ret.bitmask |= ((__metal_plic0_set_threshold(controller, context, threshold) & 0x1) << context);
...
const struct __metal_driver_vtable_riscv_plic0 __metal_driver_vtable_riscv_plic0 = {
