...
__metal_wdog_table:
	...
	.section	.text.__metal_shutdown_exit,"ax",@progbits
	.align	1
	.globl	__metal_shutdown_exit
	.type	__metal_shutdown_exit, @function
__metal_shutdown_exit:
.LFB219:
	.file 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/shutdown.h"
	.loc 1 26 49
	.cfi_startproc
	addi	sp,sp,-32
...
.LVL0:
	.cfi_endproc
.LFE219:
	.size	__metal_shutdown_exit, .-__metal_shutdown_exit
	.section	.text.metal_shutdown,"ax",@progbits
	.align	1
	.globl	metal_shutdown
	.type	metal_shutdown, @function
metal_shutdown:
.LFB220:
	.file 2 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/shutdown.c"
	.loc 2 17 31
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
	...
	sw	a0,-20(s0)
.L3:
	.loc 2 19 9 discriminator 1
 #APP
# 19 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/shutdown.c" 1
	nop
# 0 "" 2
 #NO_APP
	j	.L3
	.cfi_endproc
.LFE220:
	.size	metal_shutdown, .-metal_shutdown
	.text
.Letext0:
...
.LASF272:
	.string	"/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/shutdown.c"
.LASF130:
	.string	"transfer"
.LASF163:
	.string	"count_val"
...
.LASF82:
	.string	"clear_sw_ipi"
.LASF267:
	.string	"__metal_shutdown_vtable"
.LASF184:
