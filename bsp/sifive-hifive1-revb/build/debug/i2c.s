...
.Ltext0:
	...
	.section	.text.metal_i2c_init,"ax",@progbits
	.align	1
	.globl	metal_i2c_init
	.type	metal_i2c_init, @function
metal_i2c_init:
.LFB0:
	.file 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/i2c.h"
	.loc 1 48 51
	.cfi_startproc
	addi	sp,sp,-32
...
.LVL0:
	...
	.cfi_endproc
.LFE0:
	.size	metal_i2c_init, .-metal_i2c_init
	.section	.text.metal_i2c_write,"ax",@progbits
	.align	1
	.globl	metal_i2c_write
	.type	metal_i2c_write, @function
metal_i2c_write:
.LFB1:
	.loc 1 62 59
	.cfi_startproc
...
.LVL1:
	...
	.cfi_endproc
.LFE1:
	.size	metal_i2c_write, .-metal_i2c_write
	.section	.text.metal_i2c_read,"ax",@progbits
	.align	1
	.globl	metal_i2c_read
	.type	metal_i2c_read, @function
metal_i2c_read:
.LFB2:
	.loc 1 76 58
	.cfi_startproc
...
.LVL2:
	...
	.cfi_endproc
.LFE2:
	.size	metal_i2c_read, .-metal_i2c_read
	.section	.text.metal_i2c_transfer,"ax",@progbits
	.align	1
	.globl	metal_i2c_transfer
	.type	metal_i2c_transfer, @function
metal_i2c_transfer:
.LFB3:
	.loc 1 91 74
	.cfi_startproc
...
.LVL3:
	...
	.cfi_endproc
.LFE3:
	.size	metal_i2c_transfer, .-metal_i2c_transfer
	.section	.text.metal_i2c_get_baud_rate,"ax",@progbits
	.align	1
	.globl	metal_i2c_get_baud_rate
	.type	metal_i2c_get_baud_rate, @function
metal_i2c_get_baud_rate:
.LFB4:
	.loc 1 99 59
	.cfi_startproc
	addi	sp,sp,-32
...
.LVL4:
	...
	.cfi_endproc
.LFE4:
	.size	metal_i2c_get_baud_rate, .-metal_i2c_get_baud_rate
	.section	.text.metal_i2c_set_baud_rate,"ax",@progbits
	.align	1
	.globl	metal_i2c_set_baud_rate
	.type	metal_i2c_set_baud_rate, @function
...
.LVL5:
	...
	.cfi_endproc
.LFE5:
	.size	metal_i2c_set_baud_rate, .-metal_i2c_set_baud_rate
...
__metal_wdog_table:
	...
	.section	.text.metal_i2c_get_device,"ax",@progbits
	.align	1
	.globl	metal_i2c_get_device
	.type	metal_i2c_get_device, @function
metal_i2c_get_device:
.LFB219:
	.file 2 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/i2c.c"
	.loc 2 21 65
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
	...
	bne	a5,zero,.L13
	.loc 2 24 16
	lui	a5,%hi(__metal_i2c_table)
	lw	a4,-20(s0)
	slli	a4,a4,2
	addi	a5,a5,%lo(__metal_i2c_table)
	add	a5,a4,a5
	lw	a5,0(a5)
	j	.L14
.L13:
...
.L14:
	...
	.cfi_endproc
.LFE219:
	.size	metal_i2c_get_device, .-metal_i2c_get_device
	.text
.Letext0:
...
.LASF116:
	.string	"enable_io"
.LASF268:
	.string	"metal_i2c_set_baud_rate"
.LASF74:
...
.LASF282:
	.string	"/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/i2c.c"
.LASF92:
...
.LASF270:
	.string	"metal_i2c_get_baud_rate"
