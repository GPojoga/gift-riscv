# 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c"
...
# 5 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c" 2
...
# 9 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c" 2
...
# 8 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/riscv_clint0.h" 2
...
# 10 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c" 2
...
# 11 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c" 2
# 1 "./metal/machine.h" 1
# 89 "./metal/machine.h"
...
# 12 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c" 2
...
__metal_clint0_mtime_get(struct __metal_driver_riscv_clint0 *clint) {
    ...
    do {
        hi = (*(__typeof__(*(__metal_io_u32 *)(control_base + 49144UL + 4)) volatile *)((__metal_io_u32 *)(control_base + 49144UL + 4)))
                                                                            ;
        lo = (*(__typeof__(*(__metal_io_u32 *)(control_base + 49144UL)) volatile *)((__metal_io_u32 *)(control_base + 49144UL)))
                                                                        ;
    } while ((*(__typeof__(*(__metal_io_u32 *)(control_base + 49144UL + 4)) volatile *)((__metal_io_u32 *)(control_base + 49144UL + 4)))
...
int __metal_driver_riscv_clint0_mtimecmp_set(struct metal_interrupt *controller,
    ...
    (*(__typeof__(*(__metal_io_u32 *)(control_base + (8 * hartid) + 16384UL + 4)) volatile *)((__metal_io_u32 *)(control_base + (8 * hartid) + 16384UL + 4)))

                                               = 0xFFFFFFFF;
    (*(__typeof__(*(__metal_io_u32 *)(control_base + (8 * hartid) + 16384UL)) volatile *)((__metal_io_u32 *)(control_base + (8 * hartid) + 16384UL)))
                                                                              =
        (__metal_io_u32)time;
    (*(__typeof__(*(__metal_io_u32 *)(control_base + (8 * hartid) + 16384UL + 4)) volatile *)((__metal_io_u32 *)(control_base + (8 * hartid) + 16384UL + 4)))

                                               = (__metal_io_u32)(time >> 32);
    return 0;
}
...
# 81 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c" 3 4
                                                        ((void *)0)
# 81 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c"
                                                            , controller);
        }
        clint->init_done = 1;
    }
...
int __metal_driver_riscv_clint0_register(struct metal_interrupt *controller,
    ...
    struct metal_interrupt *intc = 
# 92 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c" 3 4
                                  ((void *)0)
# 92 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c"
                                      ;
    ...
    for (int i = 0; i < num_interrupts; i++) {
        ...
        intc = 
# 107 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c" 3 4
              ((void *)0)
# 107 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c"
                  ;
    }
...
int __metal_driver_riscv_clint0_enable(struct metal_interrupt *controller,
    ...
    if (id) {
        struct metal_interrupt *intc = 
# 155 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c" 3 4
                                      ((void *)0)
# 155 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c"
                                          ;
        struct metal_interrupt *cpu_intc = _get_cpu_intc();
        int num_interrupts =
            __metal_driver_sifive_clint0_num_interrupts(controller);
        ...
        for (int i = 0; i < num_interrupts; i++) {
            ...
            intc = 
# 168 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c" 3 4
                  ((void *)0)
# 168 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c"
                      ;
        }
...
int __metal_driver_riscv_clint0_disable(struct metal_interrupt *controller,
    ...
    if (id) {
        struct metal_interrupt *intc = 
# 185 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c" 3 4
                                      ((void *)0)
# 185 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c"
                                          ;
        struct metal_interrupt *cpu_intc = _get_cpu_intc();
        int num_interrupts =
            __metal_driver_sifive_clint0_num_interrupts(controller);
        ...
        for (int i = 0; i < num_interrupts; i++) {
            ...
            intc = 
# 198 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c" 3 4
                  ((void *)0)
# 198 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c"
                      ;
        }
...
int __metal_driver_riscv_clint0_command_request(
    ...
    case METAL_SOFTWARE_IPI_CLEAR:
        if (data) {
            hartid = *(int *)data;
            (*(__typeof__(*( __metal_io_u32 *)(control_base + (hartid * 4))) volatile *)(( __metal_io_u32 *)(control_base + (hartid * 4))))
                                                                = 0;
            rc = 0;
        }
        break;
    case METAL_SOFTWARE_IPI_SET:
        if (data) {
            ...
            (*(__typeof__(*(__metal_io_u32 *)(control_base + (hartid * 4))) volatile *)((__metal_io_u32 *)(control_base + (hartid * 4))))
                                                                 = 1;
# 248 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_clint0.c"
            __asm__ volatile("fence " "o" "," "i" ::: "memory");;
            rc = (*(__typeof__(*(__metal_io_u32 *)(control_base + (hartid * 4))) volatile *)((__metal_io_u32 *)(control_base + (hartid * 4))))
                                                                ;
            rc = 0;
        }
        break;
...
const struct __metal_driver_vtable_riscv_clint0 __metal_driver_vtable_riscv_clint0 = {
