...
.Ltext0:
	...
	.section	.text.metal_spi_init,"ax",@progbits
	.align	1
	.globl	metal_spi_init
	.type	metal_spi_init, @function
metal_spi_init:
.LFB97:
	.file 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/spi.h"
	.loc 1 60 70
	.cfi_startproc
	addi	sp,sp,-32
...
.LVL0:
	...
	.cfi_endproc
.LFE97:
	.size	metal_spi_init, .-metal_spi_init
	.section	.text.metal_spi_transfer,"ax",@progbits
	.align	1
	.globl	metal_spi_transfer
	.type	metal_spi_transfer, @function
metal_spi_transfer:
.LFB98:
	.loc 1 76 63
	.cfi_startproc
...
.LVL1:
	...
	.cfi_endproc
.LFE98:
	.size	metal_spi_transfer, .-metal_spi_transfer
	.section	.text.metal_spi_get_baud_rate,"ax",@progbits
	.align	1
	.globl	metal_spi_get_baud_rate
	.type	metal_spi_get_baud_rate, @function
metal_spi_get_baud_rate:
.LFB99:
	.loc 1 84 63
	.cfi_startproc
	addi	sp,sp,-32
...
.LVL2:
	...
	.cfi_endproc
.LFE99:
	.size	metal_spi_get_baud_rate, .-metal_spi_get_baud_rate
	.section	.text.metal_spi_set_baud_rate,"ax",@progbits
	.align	1
	.globl	metal_spi_set_baud_rate
	.type	metal_spi_set_baud_rate, @function
...
.LVL3:
	...
	.cfi_endproc
.LFE100:
	.size	metal_spi_set_baud_rate, .-metal_spi_set_baud_rate
...
__metal_wdog_table:
	...
	.section	.text.metal_spi_get_device,"ax",@progbits
	.align	1
	.globl	metal_spi_get_device
	.type	metal_spi_get_device, @function
metal_spi_get_device:
.LFB219:
	.file 2 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/spi.c"
	.loc 2 16 65
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
	...
	bgtu	a4,a5,.L9
	.loc 2 19 16
	lui	a5,%hi(__metal_spi_table)
	addi	a4,a5,%lo(__metal_spi_table)
	lw	a5,-20(s0)
	slli	a5,a5,2
	add	a5,a4,a5
	lw	a5,0(a5)
...
.L10:
	...
	.cfi_endproc
.LFE219:
	.size	metal_spi_get_device, .-metal_spi_get_device
	.text
.Letext0:
...
.LASF116:
	.string	"led_toggle"
.LASF268:
	.string	"metal_spi_set_baud_rate"
.LASF117:
	.string	"metal_led"
.LASF154:
	.string	"get_freq"
...
.LASF270:
	.string	"metal_spi_get_baud_rate"
.LASF190:
...
.LASF276:
	.string	"/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/spi.c"
.LASF216:
