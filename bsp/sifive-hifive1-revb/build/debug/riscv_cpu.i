# 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c"
...
# 5 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c" 2
# 1 "./metal/machine.h" 1
...
# 6 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c" 2
...
# 7 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c" 2
# 20 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c"
...
struct metal_cpu *__metal_driver_cpu_get(int hartid) {
    ...
    return (struct metal_cpu *)
# 29 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c" 3 4
                              ((void *)0)
# 29 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c"
                                  ;
}
...
void __attribute__((weak, interrupt))
metal_software_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_SW].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_SW].handler(METAL_INTERRUPT_ID_SW, priv); };
}
...
void __metal_default_sw_handler(int id, void *priv) {
    ...
    if (cpu) {
        ...
        intc->metal_exception_table[mcause & 0x000003FFUL](
...
void __attribute__((weak, interrupt))
metal_timer_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_TMR].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_TMR].handler(METAL_INTERRUPT_ID_TMR, priv); };
}
...
void __attribute__((weak, interrupt))
metal_external_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_EXT].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_EXT].handler(METAL_INTERRUPT_ID_EXT, priv); };
}
...
void __attribute__((weak, interrupt)) metal_lc0_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC0].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC0].handler(METAL_INTERRUPT_ID_LC0, priv); };
}


void __attribute__((weak, interrupt)) metal_lc1_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC1].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC1].handler(METAL_INTERRUPT_ID_LC1, priv); };
}


void __attribute__((weak, interrupt)) metal_lc2_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC2].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC2].handler(METAL_INTERRUPT_ID_LC2, priv); };
}


void __attribute__((weak, interrupt)) metal_lc3_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC3].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC3].handler(METAL_INTERRUPT_ID_LC3, priv); };
}


void __attribute__((weak, interrupt)) metal_lc4_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC4].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC4].handler(METAL_INTERRUPT_ID_LC4, priv); };
}


void __attribute__((weak, interrupt)) metal_lc5_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC5].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC5].handler(METAL_INTERRUPT_ID_LC5, priv); };
}


void __attribute__((weak, interrupt)) metal_lc6_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC6].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC6].handler(METAL_INTERRUPT_ID_LC6, priv); };
}


void __attribute__((weak, interrupt)) metal_lc7_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC7].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC7].handler(METAL_INTERRUPT_ID_LC7, priv); };
}


void __attribute__((weak, interrupt)) metal_lc8_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC8].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC8].handler(METAL_INTERRUPT_ID_LC8, priv); };
}


void __attribute__((weak, interrupt)) metal_lc9_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC9].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC9].handler(METAL_INTERRUPT_ID_LC9, priv); };
}


void __attribute__((weak, interrupt))
metal_lc10_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC10].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC10].handler(METAL_INTERRUPT_ID_LC10, priv); };
}


void __attribute__((weak, interrupt))
metal_lc11_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC11].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC11].handler(METAL_INTERRUPT_ID_LC11, priv); };
}


void __attribute__((weak, interrupt))
metal_lc12_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC12].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC12].handler(METAL_INTERRUPT_ID_LC12, priv); };
}


void __attribute__((weak, interrupt))
metal_lc13_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC13].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC13].handler(METAL_INTERRUPT_ID_LC13, priv); };
}


void __attribute__((weak, interrupt))
metal_lc14_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC14].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC14].handler(METAL_INTERRUPT_ID_LC14, priv); };
}


void __attribute__((weak, interrupt))
metal_lc15_interrupt_vector_handler(void) {
    void *priv; struct __metal_driver_riscv_cpu_intc *intc; struct __metal_driver_cpu *cpu = __metal_cpu_table[__metal_myhart_id()]; if (cpu) { intc = (struct __metal_driver_riscv_cpu_intc *) __metal_driver_cpu_interrupt_controller((struct metal_cpu *)cpu); priv = intc->metal_int_table[METAL_INTERRUPT_ID_LC15].exint_data; intc->metal_int_table[METAL_INTERRUPT_ID_LC15].handler(METAL_INTERRUPT_ID_LC15, priv); };
}
...
void __metal_controller_interrupt_vector(metal_vector_mode mode,
    ...
    case METAL_SELECTIVE_VECTOR_MODE:
        ...
        __asm__ volatile("csrw mtvec, %0" ::"r"(val | 0x02));
        break;
    case METAL_HARDWARE_VECTOR_MODE:
        __asm__ volatile("csrw 0x307, %0" ::"r"(trap_entry));
        __asm__ volatile(
            "csrw mtvec, %0" ::"r"(val | 0x03));
        break;
    case METAL_VECTOR_MODE:
        __asm__ volatile(
            "csrw mtvec, %0" ::"r"(trap_entry | 0x01));
        break;
    case METAL_DIRECT_MODE:
        __asm__ volatile(
            "csrw mtvec, %0" ::"r"(trap_entry & ~0x03));
        break;
    }
}
...
void __metal_driver_riscv_cpu_controller_interrupt_init(
    ...
    if (!intc->init_done) {
        ...
        for (int i = 0; i < 32; i++) {
            intc->metal_int_table[i].handler = 
# 460 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c" 3 4
                                              ((void *)0)
# 460 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c"
                                                  ;
            intc->metal_int_table[i].sub_int = 
# 461 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c" 3 4
                                              ((void *)0)
# 461 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c"
                                                  ;
            intc->metal_int_table[i].exint_data = 
# 462 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c" 3 4
                                                 ((void *)0)
# 462 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c"
                                                     ;
        }
...
int __metal_driver_riscv_cpu_controller_interrupt_enable(
    struct metal_interrupt *controller, int id) {
    return __metal_local_interrupt_enable(controller, id, 1);
}

int __metal_driver_riscv_cpu_controller_interrupt_disable(
    struct metal_interrupt *controller, int id) {
    return __metal_local_interrupt_enable(controller, id, 0);
}
...
__metal_driver_cpu_timer_controller_interrupt(struct metal_cpu *cpu) {
    ...
    return (&__metal_dt_clint_2000000.controller);
# 699 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c"
}
...
__metal_driver_cpu_sw_controller_interrupt(struct metal_cpu *cpu) {
    ...
    return (&__metal_dt_clint_2000000.controller);
# 717 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/riscv_cpu.c"
}
...
const struct __metal_driver_vtable_riscv_cpu_intc __metal_driver_vtable_riscv_cpu_intc = {
...
const struct __metal_driver_vtable_cpu __metal_driver_vtable_cpu = {
