# 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c"
...
# 5 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 2
...
# 8 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 2
...
# 9 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 2
...
# 10 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 2
...
# 11 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 2
...
# 12 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 2
# 1 "./metal/machine.h" 1
# 89 "./metal/machine.h"
...
# 13 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 2
...
# 14 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 2
...
# 15 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 2
# 51 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c"
...
static void post_rate_change_callback(void *priv) {
    ...
    if (pwm->freq != 0) {
        ...
        while (++idx < cmp_count) {
            duty = pwm->duty[idx];
            if (duty != 0) {
                ((*(__typeof__(*(__metal_io_u32 *)((base + (32UL + (idx * 4))))) volatile *)((__metal_io_u32 *)((base + (32UL + (idx * 4))))))) =
                    (duty * pwm->count_val) / 100U;
            }
        }
    }
}
...
static int __metal_driver_sifive_pwm0_enable(struct metal_pwm *gpwm) {
    ...
    if (base != 0) {
        ...
        if ((pinmux != 
# 90 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 3 4
                      ((void *)0)
# 90 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c"
                          ) && (gpwm != 
# 90 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 3 4
                                        ((void *)0)
# 90 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c"
        ...
        pwm->freq = 0;
        pwm->count_val = 0;
        ((*(__typeof__(*(__metal_io_u32 *)((base + 0UL))) volatile *)((__metal_io_u32 *)((base + 0UL))))) = 0;
        ret = 0;
    }
    return ret;
}
...
static int __metal_driver_sifive_pwm0_disable(struct metal_pwm *gpwm) {
    ...
    if (gpwm != 
# 118 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 3 4
               ((void *)0)
# 118 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c"
                   ) {

        if (pinmux != 
# 120 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 3 4
                     ((void *)0)
# 120 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c"
                         ) {
...
static int __metal_driver_sifive_pwm0_set_freq(struct metal_pwm *gpwm,
    ...
    if ((clock != 
# 145 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 3 4
                 ((void *)0)
# 145 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c"
                     ) && (gpwm != 
# 145 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 3 4
                                   ((void *)0)
# 145 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c"
        ...
        ((*(__typeof__(*(__metal_io_u32 *)((base + 32UL))) volatile *)((__metal_io_u32 *)((base + 32UL))))) = count;
        ((*(__typeof__(*(__metal_io_u32 *)((base + 0UL))) volatile *)((__metal_io_u32 *)((base + 0UL))))) |= (prescale & 0x0FUL);
        ret = 0;
...
__metal_driver_sifive_pwm0_set_duty(struct metal_pwm *gpwm, unsigned int idx,
    ...
    if ((idx > 0) && (idx < cmp_count) && (duty <= 100UL)) {
        ...
        if (phase_corr == METAL_PWM_PHASE_CORRECT_ENABLE) {
            ((*(__typeof__(*(__metal_io_u32 *)((base + 0UL))) volatile *)((__metal_io_u32 *)((base + 0UL))))) |=
                (1UL << (16 + idx));
        } else {
            ((*(__typeof__(*(__metal_io_u32 *)((base + 0UL))) volatile *)((__metal_io_u32 *)((base + 0UL))))) &=
                ~(1UL << (16 + idx));
...
static unsigned int __metal_driver_sifive_pwm0_get_duty(struct metal_pwm *gpwm,
    ...
    if ((pwm != 
# 221 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 3 4
               ((void *)0)
# 221 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c"
                   ) && (idx > 0) && (idx < cmp_count)) {
        duty = pwm->duty[idx];
    }
    return duty;
...
static unsigned int __metal_driver_sifive_pwm0_get_freq(struct metal_pwm *gpwm,
    ...
    if (pwm != 
# 235 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c" 3 4
              ((void *)0)
# 235 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_pwm0.c"
                  ) {
        freq = pwm->freq;
    }
    return freq;
...
static int __metal_driver_sifive_pwm0_trigger(struct metal_pwm *gpwm,
    ...
    if (base != 0) {
        ...
        if (mode == METAL_PWM_CONTINUOUS) {
            ((*(__typeof__(*(__metal_io_u32 *)((base + 0UL))) volatile *)((__metal_io_u32 *)((base + 0UL))))) |= (1UL << 10) |
                                                        (1UL << 9) |
                                                        (1UL << 12);
        } else {
            ((*(__typeof__(*(__metal_io_u32 *)((base + 0UL))) volatile *)((__metal_io_u32 *)((base + 0UL))))) |= (1UL << 10) |
...
static int __metal_driver_sifive_pwm0_stop(struct metal_pwm *gpwm,
    ...
    if (base != 0) {
        ...
        ((*(__typeof__(*(__metal_io_u32 *)((base + 0UL))) volatile *)((__metal_io_u32 *)((base + 0UL))))) &= ~(1UL << 12);
        ret = 0;
    }
    return ret;
}
...
__metal_driver_sifive_pwm0_cfg_interrupt(struct metal_pwm *gpwm,
    ...
    if (base != 0) {
        if (flag == METAL_PWM_INTERRUPT_ENABLE) {
            ...
            ((*(__typeof__(*(__metal_io_u32 *)((base + 0UL))) volatile *)((__metal_io_u32 *)((base + 0UL))))) |= (1UL << 8);
        } else {
            ((*(__typeof__(*(__metal_io_u32 *)((base + 0UL))) volatile *)((__metal_io_u32 *)((base + 0UL))))) &= ~(1UL << 8);
        }
        ret = 0;
...
static int __metal_driver_sifive_pwm0_clr_interrupt(struct metal_pwm *gpwm,
    ...
    if ((base != 0) && (idx < cmp_count)) {
        ...
        ((*(__typeof__(*(__metal_io_u32 *)((base + 0UL))) volatile *)((__metal_io_u32 *)((base + 0UL))))) &= ~(1UL << (28 + idx));
        ret = 0;
    }
    return ret;
}
...
const struct __metal_driver_vtable_sifive_pwm0 __metal_driver_vtable_sifive_pwm0 = {
