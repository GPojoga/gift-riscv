...
__metal_wdog_table:
	...
	.section	.text.metal_switch_interrupt_controller,"ax",@progbits
	.align	1
	.globl	metal_switch_interrupt_controller
	.type	metal_switch_interrupt_controller, @function
metal_switch_interrupt_controller:
.LFB219:
	.file 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/switch.h"
	.loc 1 43 60
	.cfi_startproc
	addi	sp,sp,-32
...
.LVL0:
	...
	.cfi_endproc
.LFE219:
	.size	metal_switch_interrupt_controller, .-metal_switch_interrupt_controller
	.section	.text.metal_switch_get_interrupt_id,"ax",@progbits
	.align	1
	.globl	metal_switch_get_interrupt_id
	.type	metal_switch_get_interrupt_id, @function
metal_switch_get_interrupt_id:
.LFB220:
	.loc 1 52 71
	.cfi_startproc
	addi	sp,sp,-32
...
.LVL1:
	...
	.cfi_endproc
.LFE220:
	.size	metal_switch_get_interrupt_id, .-metal_switch_get_interrupt_id
	.section	.text.metal_switch_get,"ax",@progbits
	.align	1
	.globl	metal_switch_get
	.type	metal_switch_get, @function
metal_switch_get:
.LFB221:
	.file 2 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/switch.c"
	.loc 2 7 52
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
	...
	.cfi_endproc
.LFE221:
	.size	metal_switch_get, .-metal_switch_get
	.text
.Letext0:
...
.LASF174:
	.string	"get_count"
.LASF272:
	.string	"metal_switch_get_interrupt_id"
.LASF69:
...
.LASF277:
	.string	"metal_switch_interrupt_controller"
.LASF140:
...
.LASF275:
	.string	"/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/switch.c"
.LASF113:
	.string	"led_enable"
.LASF93:
