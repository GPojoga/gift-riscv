# 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c"
...
# 5 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c" 2
...
# 8 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/sifive_spi0.h" 2
...
# 9 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/sifive_spi0.h" 2
...
# 10 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/sifive_spi0.h" 2
...
# 11 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/sifive_spi0.h" 2
...
# 8 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c" 2
...
# 10 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c" 2
...
# 11 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c" 2
# 55 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c"
static int configure_spi(struct __metal_driver_sifive_spi0 *spi,
    ...
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 64UL))))) &= ~(3);
    switch (config->protocol) {
    case METAL_SPI_SINGLE:
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 64UL))))) |= 0;
        break;
    case METAL_SPI_DUAL:
        if (config->multi_wire == MULTI_WIRE_ALL)
            ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 64UL))))) |= 1;
        else
            ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 64UL))))) |= 0;
        break;
    case METAL_SPI_QUAD:
        if (config->multi_wire == MULTI_WIRE_ALL)
            ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 64UL))))) |= 2;
        else
            ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 64UL))))) |= 0;
        break;
    default:
    ...
    if (config->polarity) {
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 4UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 4UL))))) |=
            (1 << 1);
    } else {
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 4UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 4UL))))) &=
            ~(1 << 1);
    ...
    if (config->little_endian) {
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 64UL))))) |= 4;
    } else {
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 64UL))))) &= ~(4);
    }


    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 64UL))))) &= ~(8);


    if (config->cs_active_high) {
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 20UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 20UL))))) = 0;
    } else {
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 20UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 20UL))))) = 1;
    }


    if ((((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 64UL))))) & (0xF << 16)) !=
        (8 << 16)) {
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 64UL))))) &= ~((0xF << 16));
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 64UL))))) |=
            (8 << 16);
    }


    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 16UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 16UL))))) = config->csid;
# 135 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c"
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 96UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 96UL))))) = 0;
...
int __metal_driver_sifive_spi0_transfer(struct metal_spi *gspi,
    ...
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 24UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 24UL))))) &= ~(3);
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 24UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 24UL))))) |= 2;
    ...
    for (i = 0; i < config->cmd_num; i++) {
        ...
        while (((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 72UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 72UL))))) & (1 << 31))
            ;

        if (tx_buf) {
            ((*(__typeof__(*(__metal_io_u8 *)(((unsigned long)control_base + 72UL))) volatile *)((__metal_io_u8 *)(((unsigned long)control_base + 72UL))))) = tx_buf[i];
        } else {
            ((*(__typeof__(*(__metal_io_u8 *)(((unsigned long)control_base + 72UL))) volatile *)((__metal_io_u8 *)(((unsigned long)control_base + 72UL))))) = 0;
        }

        endwait = metal_time() + 1;

        while ((rxdata = ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 76UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 76UL)))))) &
               (1 << 31)) {
            if (metal_time() > endwait) {
                ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 24UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 24UL))))) &=
                    ~(3);
...
# 324 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c"
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 24UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 24UL))))) &= ~(3);
...
int __metal_driver_sifive_spi0_set_baud_rate(struct metal_spi *gspi,
    ...
    if (clock != 
# 342 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c" 3 4
                ((void *)0)
# 342 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c"
                    ) {
        ...
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 0UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 0UL))))) &= ~0xFFF;
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 0UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 0UL))))) |=
            (div & 0xFFF);
    }
...
static void pre_rate_change_callback_func(void *priv) {
    ...
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 80UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 80UL))))) &= ~(7);
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 80UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 80UL))))) |= (7 & 1);

    while ((((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)control_base + 116UL))) volatile *)((__metal_io_u32 *)(((unsigned long)control_base + 116UL))))) & 1) == 0)
        ;
}
...
void __metal_driver_sifive_spi0_init(struct metal_spi *gspi, int baud_rate) {
    ...
    if (clock != 
# 388 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c" 3 4
                ((void *)0)
# 388 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c"
                    ) {
    ...
    if (pinmux != 
# 403 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c" 3 4
                 ((void *)0)
# 403 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_spi0.c"
                     ) {
...
const struct __metal_driver_vtable_sifive_spi0 __metal_driver_vtable_sifive_spi0 = {
