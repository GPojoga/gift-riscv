...
.Ltext0:
	...
	.section	.text.metal_memory_get_base_address,"ax",@progbits
	.align	1
	.globl	metal_memory_get_base_address
	.type	metal_memory_get_base_address, @function
metal_memory_get_base_address:
.LFB6:
	.file 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/memory.h"
	.loc 1 51 66
	.cfi_startproc
	addi	sp,sp,-32
	...
	.cfi_endproc
.LFE6:
	.size	metal_memory_get_base_address, .-metal_memory_get_base_address
	.section	.text.metal_memory_get_size,"ax",@progbits
	.align	1
	.globl	metal_memory_get_size
	.type	metal_memory_get_size, @function
metal_memory_get_size:
.LFB7:
	.loc 1 60 76
	.cfi_startproc
	addi	sp,sp,-32
	...
	.cfi_endproc
.LFE7:
	.size	metal_memory_get_size, .-metal_memory_get_size
	.section	.text.metal_memory_supports_atomics,"ax",@progbits
	.align	1
	.globl	metal_memory_supports_atomics
	.type	metal_memory_supports_atomics, @function
...
.LFB8:
	...
	.cfi_endproc
.LFE8:
	.size	metal_memory_supports_atomics, .-metal_memory_supports_atomics
	.section	.text.metal_memory_is_cachable,"ax",@progbits
	.align	1
	.globl	metal_memory_is_cachable
	.type	metal_memory_is_cachable, @function
metal_memory_is_cachable:
.LFB9:
	.loc 1 79 76
	.cfi_startproc
	addi	sp,sp,-32
	...
	.cfi_endproc
.LFE9:
	.size	metal_memory_is_cachable, .-metal_memory_is_cachable
...
__metal_wdog_table:
	...
	.section	.text.metal_get_memory_from_address,"ax",@progbits
	.align	1
	.globl	metal_get_memory_from_address
	.type	metal_get_memory_from_address, @function
metal_get_memory_from_address:
.LFB219:
	.file 2 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/memory.c"
	.loc 2 7 77
	.cfi_startproc
	addi	sp,sp,-48
...
.LBB3:
	.loc 2 9 30
	lui	a5,%hi(__metal_memory_table)
	addi	a4,a5,%lo(__metal_memory_table)
	lw	a5,-20(s0)
	slli	a5,a5,2
	add	a5,a4,a5
	lw	a5,0(a5)
	...
	.loc 2 11 33
	lw	a0,-24(s0)
	call	metal_memory_get_base_address
	sw	a0,-28(s0)
	.loc 2 12 48
	lw	a0,-24(s0)
	call	metal_memory_get_size
	mv	a4,a0
	.loc 2 12 45
	lw	a5,-28(s0)
	add	a5,a4,a5
...
.L12:
.LBE3:
	.loc 2 8 29 discriminator 2
	lw	a5,-20(s0)
	addi	a5,a5,1
	sw	a5,-20(s0)
.L10:
	.loc 2 8 5 discriminator 1
	lw	a4,-20(s0)
	li	a5,2
	ble	a4,a5,.L14
.LBE2:
...
.L13:
	...
	.cfi_endproc
.LFE219:
	.size	metal_get_memory_from_address, .-metal_get_memory_from_address
	.text
.Letext0:
...
.LASF276:
	.string	"/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/memory.c"
.LASF165:
	.string	"duty"
.LASF244:
...
.LASF115:
	.string	"led_off"
.LASF269:
	.string	"metal_get_memory_from_address"
.LASF12:
	.string	"short int"
.LASF189:
...
.LASF273:
	.string	"metal_memory_supports_atomics"
.LASF255:
...
.LASF270:
	.string	"metal_memory_is_cachable"
.LASF11:
...
.LASF102:
	.string	"enable_io"
.LASF278:
	.string	"metal_memory_get_base_address"
.LASF59:
