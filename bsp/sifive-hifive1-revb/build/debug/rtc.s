...
.Ltext0:
	...
	.section	.text.metal_rtc_get_rate,"ax",@progbits
	.align	1
	.globl	metal_rtc_get_rate
	.type	metal_rtc_get_rate, @function
metal_rtc_get_rate:
.LFB88:
	.file 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/rtc.h"
	.loc 1 51 71
	.cfi_startproc
	addi	sp,sp,-32
...
.LVL0:
	...
	.cfi_endproc
.LFE88:
	.size	metal_rtc_get_rate, .-metal_rtc_get_rate
	.section	.text.metal_rtc_set_rate,"ax",@progbits
	.align	1
	.globl	metal_rtc_set_rate
	.type	metal_rtc_set_rate, @function
metal_rtc_set_rate:
.LFB89:
	.loc 1 60 57
	.cfi_startproc
...
.LVL1:
	...
	.cfi_endproc
.LFE89:
	.size	metal_rtc_set_rate, .-metal_rtc_set_rate
	.section	.text.metal_rtc_get_compare,"ax",@progbits
	.align	1
	.globl	metal_rtc_get_compare
	.type	metal_rtc_get_compare, @function
...
.LVL2:
	...
	.cfi_endproc
.LFE90:
	.size	metal_rtc_get_compare, .-metal_rtc_get_compare
	.section	.text.metal_rtc_set_compare,"ax",@progbits
	.align	1
	.globl	metal_rtc_set_compare
	.type	metal_rtc_set_compare, @function
...
.LVL3:
	...
	.cfi_endproc
.LFE91:
	.size	metal_rtc_set_compare, .-metal_rtc_set_compare
	.section	.text.metal_rtc_get_count,"ax",@progbits
	.align	1
	.globl	metal_rtc_get_count
	.type	metal_rtc_get_count, @function
metal_rtc_get_count:
.LFB92:
	.loc 1 89 72
	.cfi_startproc
...
.LVL4:
	...
	.cfi_endproc
.LFE92:
	.size	metal_rtc_get_count, .-metal_rtc_get_count
	.section	.text.metal_rtc_set_count,"ax",@progbits
	.align	1
	.globl	metal_rtc_set_count
	.type	metal_rtc_set_count, @function
metal_rtc_set_count:
.LFB93:
	.loc 1 101 59
	.cfi_startproc
...
.LVL5:
	...
	.cfi_endproc
.LFE93:
	.size	metal_rtc_set_count, .-metal_rtc_set_count
	.section	.text.metal_rtc_run,"ax",@progbits
	.align	1
	.globl	metal_rtc_run
	.type	metal_rtc_run, @function
metal_rtc_run:
.LFB94:
	.loc 1 110 66
	.cfi_startproc
...
.LVL6:
	...
	.cfi_endproc
.LFE94:
	.size	metal_rtc_run, .-metal_rtc_run
	.section	.text.metal_rtc_get_interrupt,"ax",@progbits
	.align	1
	.globl	metal_rtc_get_interrupt
	.type	metal_rtc_get_interrupt, @function
...
.LVL7:
	...
	.cfi_endproc
.LFE95:
	.size	metal_rtc_get_interrupt, .-metal_rtc_get_interrupt
	.section	.text.metal_rtc_get_interrupt_id,"ax",@progbits
	.align	1
	.globl	metal_rtc_get_interrupt_id
	.type	metal_rtc_get_interrupt_id, @function
metal_rtc_get_interrupt_id:
.LFB96:
	.loc 1 127 74
	.cfi_startproc
	addi	sp,sp,-32
...
.LVL8:
	...
	.cfi_endproc
.LFE96:
	.size	metal_rtc_get_interrupt_id, .-metal_rtc_get_interrupt_id
...
__metal_wdog_table:
	...
	.section	.text.metal_rtc_get_device,"ax",@progbits
	.align	1
	.globl	metal_rtc_get_device
	.type	metal_rtc_get_device, @function
metal_rtc_get_device:
.LFB219:
	.file 2 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/rtc.c"
	.loc 2 24 51
	.cfi_startproc
	addi	sp,sp,-32
	.cfi_def_cfa_offset 32
	...
	bgt	a5,zero,.L20
	.loc 2 27 16
	lui	a5,%hi(__metal_rtc_table)
	lw	a4,-20(s0)
	slli	a4,a4,2
	addi	a5,a5,%lo(__metal_rtc_table)
	add	a5,a4,a5
	lw	a5,0(a5)
	j	.L21
.L20:
...
.L21:
	...
	.cfi_endproc
.LFE219:
	.size	metal_rtc_get_device, .-metal_rtc_get_device
	.text
.Letext0:
...
.LASF270:
	.string	"metal_rtc_get_interrupt"
.LASF67:
...
.LASF268:
	.string	"metal_rtc_get_interrupt_id"
.LASF103:
	.string	"disable_io"
.LASF243:
...
.LASF282:
	.string	"/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/rtc.c"
.LASF128:
	.string	"write"
.LASF102:
	.string	"enable_io"
