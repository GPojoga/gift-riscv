# 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_gpio0.c"
...
# 5 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_gpio0.c" 2
...
# 8 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/sifive_gpio0.h" 2
...
# 9 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_gpio0.c" 2
...
# 10 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_gpio0.c" 2
# 1 "./metal/machine.h" 1
# 89 "./metal/machine.h"
...
# 11 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_gpio0.c" 2

int __metal_driver_sifive_gpio0_enable_input(struct metal_gpio *ggpio,
                                             long source) {
    long base = __metal_driver_sifive_gpio0_base(ggpio);

    (*(__typeof__(*(__metal_io_u32 *)(base + 4UL)) volatile *)((__metal_io_u32 *)(base + 4UL)))
                                                                |= source;
...
long __metal_driver_sifive_gpio0_input(struct metal_gpio *ggpio) {
    ...
    return (*(__typeof__(*(__metal_io_u32 *)(base + 0UL)) volatile *)((__metal_io_u32 *)(base + 0UL)))
                                                            ;
}
...
long __metal_driver_sifive_gpio0_output(struct metal_gpio *ggpio) {
    ...
    return (*(__typeof__(*(__metal_io_u32 *)(base + 12UL)) volatile *)((__metal_io_u32 *)(base + 12UL)))
                                                           ;
}
...
int __metal_driver_sifive_gpio0_disable_output(struct metal_gpio *ggpio,
    ...
    (*(__typeof__(*(__metal_io_u32 *)(base + 8UL)) volatile *)((__metal_io_u32 *)(base + 8UL)))
                                                                 &= ~source;
...
int __metal_driver_sifive_gpio0_output_set(struct metal_gpio *ggpio,
    ...
    (*(__typeof__(*(__metal_io_u32 *)(base + 12UL)) volatile *)((__metal_io_u32 *)(base + 12UL))) |=
        value;
...
int __metal_driver_sifive_gpio0_enable_io(struct metal_gpio *ggpio, long source,
    ...
    (*(__typeof__(*(__metal_io_u32 *)(base + 60UL)) volatile *)((__metal_io_u32 *)(base + 60UL)))
                                                               |= source;
    (*(__typeof__(*(__metal_io_u32 *)(base + 56UL)) volatile *)((__metal_io_u32 *)(base + 56UL))) |=
        dest;
...
int __metal_driver_sifive_gpio0_config_int(struct metal_gpio *ggpio,
    ...
    switch (intr_type) {
    case 0:
        (*(__typeof__(*(__metal_io_u32 *)(base + 24UL)) volatile *)((__metal_io_u32 *)(base + 24UL)))
                                                                   &= ~source;
        (*(__typeof__(*(__metal_io_u32 *)(base + 32UL)) volatile *)((__metal_io_u32 *)(base + 32UL)))
                                                                   &= ~source;
        (*(__typeof__(*(__metal_io_u32 *)(base + 40UL)) volatile *)((__metal_io_u32 *)(base + 40UL)))
                                                                   &= ~source;
        (*(__typeof__(*(__metal_io_u32 *)(base + 48UL)) volatile *)((__metal_io_u32 *)(base + 48UL)))
                                                                  &= ~source;
        break;
    case 1:
        (*(__typeof__(*(__metal_io_u32 *)(base + 24UL)) volatile *)((__metal_io_u32 *)(base + 24UL)))
...
int __metal_driver_sifive_gpio0_clear_int(struct metal_gpio *ggpio, long source,
    ...
    switch (intr_type) {
    case 1:
        (*(__typeof__(*(__metal_io_u32 *)(base + 28UL)) volatile *)((__metal_io_u32 *)(base + 28UL)))
                                                                   |= source;
        break;
    case 2:
        (*(__typeof__(*(__metal_io_u32 *)(base + 36UL)) volatile *)((__metal_io_u32 *)(base + 36UL)))
                                                                   |= source;
        break;
    case 3:
        (*(__typeof__(*(__metal_io_u32 *)(base + 28UL)) volatile *)((__metal_io_u32 *)(base + 28UL)))
        ...
        break;
    case 5:
        (*(__typeof__(*(__metal_io_u32 *)(base + 44UL)) volatile *)((__metal_io_u32 *)(base + 44UL)))
                                                                   |= source;
        break;
    case 4:
        (*(__typeof__(*(__metal_io_u32 *)(base + 52UL)) volatile *)((__metal_io_u32 *)(base + 52UL)))
                                                                  |= source;
        break;
    case 6:
        (*(__typeof__(*(__metal_io_u32 *)(base + 44UL)) volatile *)((__metal_io_u32 *)(base + 44UL)))
...
const struct __metal_driver_vtable_sifive_gpio0 __metal_driver_vtable_sifive_gpio0 = {
