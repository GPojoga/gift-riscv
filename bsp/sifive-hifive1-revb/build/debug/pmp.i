# 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/pmp.c"
...
# 5 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/pmp.c" 2
# 1 "./metal/machine.h" 1
...
# 6 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/pmp.c" 2
...
struct metal_pmp *metal_pmp_get_device(void) {
    ...
    return (&__metal_dt_pmp);



}
# 29 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/pmp.c"
...
# 54 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/pmp.c"
...
int metal_pmp_set_region(struct metal_pmp *pmp, unsigned int region,
    ...
    if ((*((char *)&(old_config))) != (*((char *)&(config)))) {

        cfgmask = (0xFF << (8 * (region % 4)));
        pmpcfg = ((*((char *)&(config))) << (8 * (region % 4)));
...
# 258 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/pmp.c"
    return 0;
}
...
# 310 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/pmp.c"
    *config = (*((struct metal_pmp_config *)(char *)&(*pmpcfg_convert)));
