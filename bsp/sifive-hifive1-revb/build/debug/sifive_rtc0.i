# 1 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_rtc0.c"
...
# 5 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_rtc0.c" 2
...
# 8 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/sifive_rtc0.h" 2
...
# 11 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/sifive_rtc0.h" 2
...
# 12 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/drivers/sifive_rtc0.h" 2
...
# 8 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/metal/rtc.h" 2
...
# 9 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_rtc0.c" 2
# 1 "./metal/machine.h" 1
# 89 "./metal/machine.h"
...
# 10 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_rtc0.c" 2
...
# 47 "/home/gra2p/Documents/uva_courses/rp1/tools/riscv64-unknown-elf-toolchain-10.2.0-2020.12.8-x86_64-linux-ubuntu14/riscv64-unknown-elf/include/sys/cdefs.h" 3 4
# 1 "/home/gra2p/Documents/uva_courses/rp1/tools/riscv64-unknown-elf-toolchain-10.2.0-2020.12.8-x86_64-linux-ubuntu14/lib/gcc/riscv64-unknown-elf/10.2.0/include/stddef.h" 1 3 4
...
# 12 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_rtc0.c" 2
# 25 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_rtc0.c"
uint64_t
...
__metal_driver_sifive_rtc0_get_compare(const struct metal_rtc *const rtc) {
    ...
    const uint32_t shift =
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 64UL))))) & 0xF;

    return ((uint64_t)((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 96UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 96UL))))) << shift);
}
...
__metal_driver_sifive_rtc0_set_compare(const struct metal_rtc *const rtc,
    ...
    while (comp_shifted > 
# 58 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_rtc0.c" 3 4
                         (0xffffffffUL)
# 58 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_rtc0.c"
                                          ) {
        shift += 1;
    ...
    uint32_t cfg = ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 64UL)))));
    cfg &= ~(0xF);
    cfg |= (0xF & shift);
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 64UL))))) = cfg;


    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 96UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 96UL))))) = (uint32_t)comp_shifted;
...
__metal_driver_sifive_rtc0_get_count(const struct metal_rtc *const rtc) {
    ...
    uint64_t count = ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 76UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 76UL)))));
    count <<= 32;
    count |= ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 72UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 72UL)))));
...
uint64_t __metal_driver_sifive_rtc0_set_count(const struct metal_rtc *const rtc,
    ...
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 76UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 76UL))))) = (
# 90 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_rtc0.c" 3 4
                                                   (0x7fffffff * 2U + 1U) 
# 90 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_rtc0.c"
                                                            & (count >> 32));
    ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 72UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 72UL))))) = (
# 91 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_rtc0.c" 3 4
                                                   (0x7fffffff * 2U + 1U) 
# 91 "/home/gra2p/Documents/uva_courses/rp1/src/freedom-metal/src/drivers/sifive_rtc0.c"
                                                            & count);
...
int __metal_driver_sifive_rtc0_run(const struct metal_rtc *const rtc,
    ...
    default:
    case METAL_RTC_STOP:
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 64UL))))) &= ~((1 << 12));
        break;
    case METAL_RTC_RUN:
        ((*(__typeof__(*(__metal_io_u32 *)(((unsigned long)base + 64UL))) volatile *)((__metal_io_u32 *)(((unsigned long)base + 64UL))))) |= (1 << 12);
        break;
...
const struct __metal_driver_vtable_sifive_rtc0 __metal_driver_vtable_sifive_rtc0 = {
